...
export const robotBehaviorRuleSchema = z.discriminatedUnion('type', [
  ...(behaviorRuleSchema.options as unknown as [
...
export const robotActionTypeSchema = z.enum(['alert', 'command', 'webhook', 'noop']);
